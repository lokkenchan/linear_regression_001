...
from linear_regression_001.utils.paths import PROJECT_ROOT,DATA_DIR,RAW,INTERIM,EXTERNAL,PROCESSED,FEATURES,INFERENCE,MODELS
...
from linear_regression_001.models import train,predict,evaluate,evaluate_model